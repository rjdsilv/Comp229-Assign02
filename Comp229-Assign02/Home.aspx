        ...
        <div class="col-xs-5 body-column">
            ...
            <div class="body-column-content">
                <p>
                    ...
                    services that our customer may need. Our mission is to make our customers life easier by offering them an unified serivice platform.
                </p>
            </div>
        </div>
        ...
        <div class="col-xs-5 body-column">
            ...
            <div class="body-column-content">
                <p>
                    ...
                    click <asp:HyperLink ToolTip="Click here to go to the survey." runat="server" NavigateUrl="~/Survey" Text="HERE" />
                </p>
            </div>
        </div>
    </div>
